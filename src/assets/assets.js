...
export const projects = [
  {
    ...
    buttons: [
      { label: "View Live", url: "https://food-delivery-apps.vercel.app" },
      { label: "GitHub", url: "https://github.com/Amazing-Tech1/Food-Delivery-app" }
    ]
  },
  {
    id: 2,
    ...
    buttons: [
      { label: "View Live", url: "https://shopping-app-drab.vercel.app" },
      { label: "GitHub", url: "https://github.com/Amazing-Tech1/shopping-app-" }
    ]
  },
  {
    id: 3,
    ...
    buttons: [
      { label: "GitHub", url: "https://github.com/Amazing-Tech1/E-Commerce-Panel" }
    ]
  },
  {
    id: 4,
    ...
    buttons: [
      { label: "View Live", url: "https://youtube-clone-one-henna.vercel.app" },
      { label: "GitHub", url: "https://github.com/Amazing-Tech1/youtube-clone" }
    ]
  }
];